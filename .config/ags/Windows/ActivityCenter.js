                ...
                children: [
                    Widget.Box({
                        children: [
                            ...
                            Widget.Box({
                                vertical: true,
                                children: [NotificationWidget(24, 12)],
                            }),
                        ],
                    }),
                    Media(),
...
export const ActivityCenterButton = () =>
    Widget.Button({
        class_name: "button",
        on_primary_click: () => execAsync(`ags -t activity-center`), //toggle activity center window based on which monitor the clicked button is on
        child: Clock(),
    });

export const ActivityCenter = () =>
    Widget.Window({
        name: `activity-center`, // name has to be unique
        css: `background-color: unset;`,
        visible: false,
        anchor: ["top", "bottom", "right", "left"], // Anchoring on all corners is used to stretch the window across the whole screen
        //anchor: ["top"], // Debug
        exclusivity: "normal",
        child: CloseOnClickAway("activity-center", container(), "top-center"),
    });
